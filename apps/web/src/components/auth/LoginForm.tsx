...
export function LoginForm() {
  const [state, magicLinkAction, isMagicLinkPending] = useActionState(
    signInWithMagicLink,
  ...
  function handleOAuth(provider: OAuthProvider) {
    startOAuthTransition(async () => {
      ...
      if (result.error) {
        // OAuth errors are shown via redirect URL error param
      }
    })
  }

  const isPending = isMagicLinkPending || isOAuthPending
